...
public interface LocationRepository extends JpaRepository<Location,Long> {
    ...
    @Query(value=" select l.* from location l where l.code_secret = :code and l.date_fin < CURRENT_DATE and l.client_id in (select c.id from client c, client_abonne ca  where ca.code_secret = :code and c.carte_bancaire= :cb)" , nativeQuery=true)
